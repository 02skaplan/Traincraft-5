...
public enum EnumTrains implements ITrainRecord
{
	...
	Freight60centerbeam("60centerbeam",  com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight60centerbeam.class, ItemIDs.minecart60centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Yellow", "Green", "LightGrey"}), 10, 54, null),
	Freight66centerbeam("66centerbeam",  com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight66centerbeam.class, ItemIDs.minecart66centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Cyan", "Black", "Green", "Lime", "Red", "Purple", "LightBlue", "Pink", "Blue", "Yellow"}), 10, 54, null),
	Freight73centerbeam("73centerbeam",  com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight73centerbeam.class, ItemIDs.minecart73centerbeam.item, "Centerbeam Flat", 3.5, TraincraftUtil.getBytesFromColors(new String[] {"Pink", "Cyan", "Green", "Orange", "Yellow", "Red", "Purple"}), 10, 54, null),
	...
	Thrall63centerbeam("63centerbeam",  Thrall63centerbeam.class, ItemIDs.minecartthrall63centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Yellow", "Red", "Black", "Cyan", "Skin16", "Skin17", "Purple"}), 12, 45, null),
	...
	VersaLongi("VersaLongi", VersaLongi.class, ItemIDs.minecartVersaLongi.item, "Open Top Hopper", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Black", "Orange", "Brown", "Skin16", "Grey", "Pink", "LightBlue", "Yellow"}), 15, 36, null),
	VersaTrans("VersaTrans", VersaTrans.class, ItemIDs.minecartVersaTrans.item, "Open Top Hopper", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Grey", "LightGrey", "Black"}), 15, 36, null),
	...
	WoodchipHopper("Woodchip Hopper", WoodchipHopper.class, ItemIDs.minecartWoodchipHopper.item, "Open Top Hopper", 3, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Blue", "Green", "Orange", "Red", "White", "Cyan", "Skin18", "Skin19", "Skin16", "Skin17"}), 14, 45, null),
	OreJenny("Ore Jenny", OreJenny.class, ItemIDs.minecartOreJenny.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "Orange", "Pink", "Black"}), 18, 27, null),
	PRRGLaHopper("PRR GLa hopper", PRRGLaHopper.class, ItemIDs.minecartPRRGLaHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Black", "Yellow", "Magenta", "Blue", "LightGrey"}), 16, 27, null),
	...
	AAR50TonHopper("AAR 50 Ton Hopper", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.AAR50TonHopper.class, ItemIDs.minecartAAR50TonHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Purple", "Skin16"}), 16, 27, null),
	AAR70TonHopper("AAR 70 Ton Hopper", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.AAR70TonHopper.class, ItemIDs.minecartAAR70TonHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Magenta", "Skin16", "Skin17", "Skin18"}), 16, 27, null),
	...
	SkeletonCar("Skeleton", SkeletonLogCar.class, ItemIDs.minecartSkeletonLogCar.item, "Log Flat", 1, TraincraftUtil.getBytesFromColors(new String[]{"Black","Grey", "LightGrey"}), 18, 18, null),
	...
	IngotPig("IngotPig", IngotPig.class, ItemIDs.minecartIngotPig.item, "Other", 2, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Black"}), 18, 9, null),
