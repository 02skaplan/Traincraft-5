...
public enum EnumTrains implements ITrainRecord
{
	...
	F9A("F9A", DieselF9A.class, ItemIDs.minecartF9A.item, "diesel", 1750, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Cyan", "Brown", "Black", "Yellow", "Grey", "Orange", "Skin17", "Skin18", "Skin19"}), 18, -2.6),
	F9B("F9B", DieselF9B.class, ItemIDs.minecartF9B.item, "diesel", 1750, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan", "Yellow", "Grey", "Orange", "Skin16"}), 18, -2.4),
