...
public enum EnumTrains implements ITrainRecord
{
	...
	SkookTender("Skookum Tender", TenderSkookTender.class, ItemIDs.minecartSkookTender.item,"tender",0,0,2,0,0,0,0,0,15000,null,18,0),
	...
	Shay3TruckTender("3 Truck Shay Tender", TenderShay3Truck.class, ItemIDs.minecartShay3TruckTender.item,"tender",0,0,2,0,0,0,0,0,10000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "White"}),22,0),
	ClimaxB("ClimaxB", SteamClimaxB.class, ItemIDs.minecartClimaxB.item, "steam", 838, 35, 0, 80, 80, 190, 0.8, 0.9, 9000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "LightGrey", "Cyan"}), 15, -1.8),

	F01("F01", SteamF01.class, ItemIDs.minecartF01.item, "steam", 450,65,0,50,160,120,0.7,0.8,9000, TraincraftUtil.getBytesFromColors(new String[] {"Grey"}),16,-1.7),
	...
	VanderbackTender("VanderbackTender", TenderVanderback.class, ItemIDs.minecartVanderbackTender.item,"tender",0,0,2,0,0,0,0,0,29000, TraincraftUtil.getBytesFromColors(new String[] {"Grey"}),18,0),
	SquanderbackTender("SquanderbackTender", TenderSquanderback.class, ItemIDs.minecartSquanderbackTender.item,"tender",0,0,2.1,0,0,0,0,0,34000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Green"}),18,0,(new String[] {" this started life a shitpost but i liked it too much"})),
	...
	WCPBaler("WCPBaler", TenderBaler.class, ItemIDs.minecartWCPBaler.item,"tender",0,0,3,0,0,0,0,0,15000, null,18,0),
	...
	Tender10k("Tender10k", Tender10k.class, ItemIDs.minecartTender10k.item,"tender",0,0,3,0,0,0,0,0,38000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin16", "Skin17", "Skin18", "Yellow", "Purple", "Pink", "Skin19", "Skin20", "Skin21", "Skin22"}),18,0),
	TenderDeseret("TenderDeseret", TenderDeseret.class, ItemIDs.minecartTenderDeseret.item,"tender",0,0,4,0,0,0,0,0,57000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin16", "Skin17", "Skin18"}),18,0),
	HCS_c57("HCS_c57", SteamHCS_c57.class, ItemIDs.minecartHCS_c57.item, "steam", 1753, 85, 0, 75, 75, 190, 0.85, 0.8, 2000, TraincraftUtil.getBytesFromColors(new String[] {"Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Cyan", "Skin25", "Skin23", "Skin24", "Skin26", "Skin27"}), 14, -2.20),
	HCS_9k_Tender("HCS_9k_Tender", HCS_9k_Tender.class, ItemIDs.minecartHCS_9k_Tender.item,"tender",0,0,4,0,0,0,0,0,34000, TraincraftUtil.getBytesFromColors(new String[] {"Skin19","Skin21", "Skin20", "Skin16", "Skin17", "Skin18"}),18,0),
	...
	Onion("Onion", SteamOnion.class, ItemIDs.minecartOnion.item, "steam", 350,191,0,10,240,190,0.9999,14.99999,8000, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Orange", "Blue", "Grey", "Red", "Yellow", "White", "Brown", "LightGrey", "Pink"}),17,-1.3),
	...
	NP_13C_Tender("NP_13C_Tender", TenderNP_13C.class, ItemIDs.minecartNP_13C_tender.item,"tender",0,0,3.75,0,0,0,0,0,31000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Black"}),18,0),
	...
	Tender460("Tender460", Tender460.class, ItemIDs.minecartTender460.item,"tender",0,0,3,0,0,0,0,0,26000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin16", "Red", "Yellow", "Skin17"}),18,0),
	...
	PETender("Tender PETender",TenderPETender.class, ItemIDs.minecartPETender.item,"tender",0,0,1.5,0,0,0,0,0,20000,null,18,0),
	PMNstender("PMNstender",TenderPMNstender.class, ItemIDs.minecartPMNstender.item,"tender",0,0,1.5,0,0,0,0,0,83000,TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Yellow", "Orange", "White"}),15,0),
	...
	TenderLima2_8_0("TenderLima2_8_0", TenderLima2_8_0.class, ItemIDs.minecartTenderLima2_8_0.item,"tender",0,0,3,0,0,0,0,0,26000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "Yellow", "Red"}),18,0),

	//EMD//
	F3A("F3A", DieselF3A.class, ItemIDs.minecartF3A.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan", "Skin31", "Skin17", "Magenta", "Skin16", "Red", "Black", "Yellow", "Grey", "Orange", "White", "Pink", "Blue", "Purple", "LightBlue", "Lime", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin32", "Skin33"}), 18, -2.6),
	F3B("F3B", DieselF3B.class, ItemIDs.minecartF3B.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan", "Skin31", "Skin17", "Black", "Yellow", "Grey", "Orange", "LightBlue", "Lime", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27"}), 18, -2.4),
	F7A("F7A", DieselF7A.class, ItemIDs.minecartF7A.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin17", "Magenta", "Yellow", "Grey", "Orange", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Skin32", "Skin33", "Red", "Pink", "LightGrey", "White", "Skin34", "Skin35", "Skin36", "Skin37","Skin38"}), 18, -2.6),
	F7B("F7B", DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin17", "Magenta", "Yellow", "Grey", "Orange", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Red", "LightGrey", "Skin34", "Skin36", "Skin37","Skin38"}), 18, -2.4),
	F9A("F9A", DieselF9A.class, ItemIDs.minecartF9A.item, "diesel", 1750, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Cyan", "Skin20", "Brown", "Black", "Yellow", "Grey", "Orange", "Skin17", "Skin18", "Skin19"}), 18, -2.6),
	F9B("F9B", DieselF9B.class, ItemIDs.minecartF9B.item, "diesel", 1750, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan", "Skin20", "Yellow", "Grey", "Orange", "Skin16"}), 18, -2.4),
	...
	CF7angle2("CF7angle2", DieselCF7angle2.class, ItemIDs.minecartCF7angle2.item, "diesel", 1470, 90, 0, 15, 0, 200, 0.6, 0.9, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Skin16", "Green", "White", "Skin17", "Cyan"}), 15, -2.5),
	CF7angle3("CF7angle3", DieselCF7angle3.class, ItemIDs.minecartCF7angle3.item, "diesel", 1500, 116, 0, 25, 0, 200, 0.825, 0.8, 10000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Cyan", "Skin16", "Skin17", "Skin18", "Skin19", "Green", "Skin20", "Grey", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Brown", "Skin26", "Purple", "Lime", "LightGrey", "Pink", "Skin27", "Skin28"}), 15, -2.5),
	CF7b("CF7b", DieselCF7b.class, ItemIDs.minecartCF7b.item, "diesel", 1500, 116, 0, 25, 0, 200, 0.825, 0.8, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan"}), 15, -2.5),
	...
	E9A("E9A", DieselE9A.class, ItemIDs.minecartE9A.item, "diesel", 2400, 188, 0, 25, 0, 200, 0.8, 0.69, 11000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Skin16"}), 12, -3.75),
	...
	CE8("CE8", DieselCE8.class, ItemIDs.minecartCE8.item, "diesel", 2250, 116, 0, 25, 0, 200, 0.8, 0.69, 11000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Brown", "LightGrey"}), 12, -3.65),
	...
	GP7u("GP7u",DieselGP7u.class, ItemIDs.minecartGP7u.item, "diesel", 1500, 100, 0, 25, 0, 200, 0.65, 0.85, 18000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Blue", "LightGrey", "White", "Skin16", "Grey", "Green", "Cyan", "Skin17"}), 16, -2.9),
	...
	GP15("GP15", DieselGP15.class, ItemIDs.minecartGP15.item, "diesel", 1500, 105, 0, 15, 0, 200, 0.85, 0.85, 15000, TraincraftUtil.getBytesFromColors(new  String[] {"Yellow", "LightGrey", "LightBlue", "Skin26", "Skin16", "Blue", "Skin17", "Skin21", "Skin18", "Skin19", "Skin20", "Skin22"}), 16, -2.6),
	GP15T("GP15T", DieselGP15T.class, ItemIDs.minecartGP15T.item, "diesel", 1500, 105, 0, 15, 0, 200, 0.85, 0.85, 15000, TraincraftUtil.getBytesFromColors(new  String[] {"Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Skin32"}), 16, -2.6),
	GP18("GP18", DieselGP18.class, ItemIDs.minecartGP18.item, "diesel", 1800, 100, 0, 25, 0, 200, 0.80, 0.85, 18000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "Blue", "Pink", "Skin16", "Skin17", "Purple", "Skin18", "Skin19", "LightGrey", "Skin20", "Skin21"}), 16, -2.9),
	GP20("GP20", DieselGP20.class, ItemIDs.minecartGP20.item, "diesel", 2000, 105, 0, 30, 0, 200, 0.80, 0.85, 18000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey","Orange","Yellow","Skin25","Red","Skin24","Black","Blue","Green","Skin21","Skin22","LightBlue","Skin23","Skin17","Skin18","Skin19","Skin20"}), 16, -2.9),
	GP30("GP30", DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 134, 0, 30, 0, 200, 0.8, 0.85, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Black", "Blue", "Skin23", "Skin24", "LightBlue", "Grey", "Skin17", "Yellow", "Green", "Skin18", "Skin16", "Purple", "Pink", "Red", "Skin19", "LightGrey", "Skin20", "Skin21", "Skin22", "Magenta", "Lime", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29"}), 15, -2.9),
	GP35("GP35", DieselGP35.class, ItemIDs.minecartGP35.item, "diesel", 2500, 105, 0, 25, 0, 190, 0.8, 0.85, 15000, TraincraftUtil.getBytesFromColors(new  String[] {"Red", "Skin19", "Black", "Magenta", "Skin16", "Grey", "Skin17", "LightBlue", "LightGrey", "Skin18", "Pink", "Yellow", "Purple", "Lime", "Cyan", "Skin20", "Skin21", "White", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Green", "Skin31", "Skin32", "Skin33", "Skin34", "Skin35", "Skin37", "Brown", "Skin36", "Skin38", "Skin39", "Skin40"}), 15, -2.9),
	...
	GP38("GP38", DieselGP38.class, ItemIDs.minecartGP38.item, "diesel", 2000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"LightGrey", "Cyan", "Grey", "Skin18", "Skin26", "Skin21", "Skin22", "Skin23", "Skin24", "Magenta", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Red", "Skin33", "Skin34", "Skin35", "Skin36", "Skin37", "Skin38", "Skin39", "Skin40", "Skin41"}), 14, -2.9),
	GP38Dash2("GP38Dash2", DieselGP38dash2.class, ItemIDs.minecartGP38dash2.item, "diesel", 2000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Yellow", "Green", "Skin16", "Black", "Skin17", "Skin19", "Skin20", "Orange", "Skin25", "Skin29", "Skin30", "Skin31", "Blue", "LightBlue"}), 14, -3.1),
	GP39("GP39", DieselGP39.class, ItemIDs.minecartGP39.item, "diesel", 2300, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Green", "Grey", "Blue", "Skin38", "Skin39"}), 14, -2.9),
	...
	GP39TDash2("GP39TDash2", DieselGP39TDash2.class, ItemIDs.minecartGP39TDash2.item, "diesel", 2300, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Green"}), 14, -2.9),
	GP39TDash2B("GP39TDash2B", DieselGP39TDash2B.class, ItemIDs.minecartGP39TDash2B.item, "diesel", 2300, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Green"}), 14, -2.9),
	GP40("GP40", DieselGP40.class, ItemIDs.minecartGP40.item, "diesel", 3000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Pink", "Red", "Skin20", "Grey", "Orange", "Skin21", "Skin22", "Green", "Magenta", "Skin19", "Skin23", "Skin24", "Skin25", "Skin28", "Skin30", "Skin32", "Skin33", "Skin34", "Cyan", "Skin35", "Lime", "Skin36", "Skin37", "Skin38", "Skin39", "Skin40", "Skin41", "Skin42", "Skin43"}), 14, -2.9),
	GP40Dash2("GP40Dash2", DieselGP40Dash2.class, ItemIDs.minecartGP40Dash2.item, "diesel", 3000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Skin31", "Skin16", "Skin17", "Skin27", "Lime", "White", "Skin18", "LightGrey", "Black", "Skin26", "Skin29", "Grey", "Blue", "LightBlue", "Skin32", "Skin42"}), 14, -2.9),
	...
	GP49("GP49", DieselGP49.class, ItemIDs.minecartGP49.item, "diesel", 2800, 105, 0, 35, 0, 200, 0.65, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Blue", "LightGrey", "Purple"}), 14, -3.1),

	SD9("SD9", DieselSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 35, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Black", "Orange", "Skin17", "Cyan", "LightGrey", "Skin18", "Yellow", "Magenta", "Skin19", "Skin20", "Pink", "Skin21", "Skin22"}), 14, -3.05),
	SD38("SD38", DieselSD38.class, ItemIDs.minecartSD38.item, "diesel", 2000, 105, 0, 10, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"White", "LightGrey", "LightBlue", "Blue", "Skin16", "Cyan", "Skin17", "Black", "Skin18", "Grey", "Skin20", "Skin21", "Skin19"}), 12, -3.45),
	...
	SD40("SD40", DieselSD40.class, ItemIDs.minecartSD40.item, "diesel", 3000, 105, 0, 20, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "LightGrey", "Skin16", "Red", "Skin17", "Cyan", "Black", "Skin18", "Skin20", "Skin21", "Skin22", "Grey", "Skin23", "Skin41", "Skin42", "Skin43"}), 12, -3.45),
	...
	SD40T2("SD40T-2", DieselSD40T2.class, ItemIDs.minecartSD40T2.item, "diesel", 3000, 105, 0, 10, 0, 200, 0.75, 0.85, 14000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Red", "Skin17", "Yellow", "Magenta", "Blue", "LightGrey", "LightBlue", "Skin16", "Skin18", "Green", "White", "Cyan", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24"}), 12, -3.45),
	SD40dash2B("SD40-2B", DieselSD40dash2B.class, ItemIDs.minecartSD40dash2B.item, "diesel", 3000, 105, 0, 5, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Red"}), 12, -3.8),
	...
	SDP45("SDP45", DieselSDP45.class, ItemIDs.minecartSDP45.item, "diesel", 3600, 160, 0, 20, 0, 200, 0.75, 0.85, 14000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Grey", "Blue", "Green", "Skin16", "Purple", "Pink"}), 12, -3.45),
	...
	SD50("SD50", DieselSD50.class, ItemIDs.minecartSD50.item, "diesel", 3600, 142, 0, 20, 0, 200, 0.75, 0.85, 23000, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Pink", "Blue", "LightBlue", "Brown", "Black", "White", "LightGrey", "Green", "Cyan", "Grey", "Yellow"}), 12, -3.725),
	SD60("SD60", DieselSD60.class, ItemIDs.minecartSD60.item, "diesel", 3800, 113, 0, 20, 0, 200, 0.75, 0.85, 23000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Skin16", "Red", "Yellow", "Brown", "LightBlue", "LightGrey", "Purple", "Green", "Lime", "Skin18", "Skin19", "Skin20", "White", "Skin17"}), 12, -3.725),
	...
	SD70ACe("SD70ACe", DieselSD70ACe.class, ItemIDs.minecartSD70ACe.item, "diesel", 4300, 110, 0, 45, 0, 180, 0.8, 0.87, 21000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Blue", "LightBlue", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Black", "Skin27", "Skin28", "Skin29"}), 12, -4.0),
	SD70ACe_H("SD70ACe_H", DieselSD70ACe_H.class, ItemIDs.minecartSD70ACe_H.item, "diesel", 4300, 110, 0, 45, 0, 180, 0.8, 0.87, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Skin16", "Purple", "Grey", "Yellow", "Green", "Orange", "White", "Blue", "Lime", "Black", "LightGrey"}), 12, -4.0),

	SW1("SW1", DieselSW1.class, ItemIDs.minecartSW1.item, "diesel", 600, 105, 0, 35, 0, 160, 0.6, 0.890, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Green", "Skin22", "LightBlue", "Skin16", "Black", "Skin17", "Pink", "Purple", "Skin18", "Skin19", "Lime", "Skin20", "Skin21", "Skin23", "Skin24", "Skin25", "Skin26", "Cyan", "Skin27", "Skin28", "Skin29"}), 16, -2),
	...
	SW10("SW10", DieselSW10.class, ItemIDs.minecartSW10.item, "diesel", 1200, 81, 0, 45, 0, 200, 0.85, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "LightGrey", "Cyan", "Skin16", "Skin17", "Skin18", "Purple", "Orange"}), 16, -2.0),
	SW900("SW900", DieselSW900.class, ItemIDs.minecartSW900.item, "diesel", 900, 105, 0, 35, 0, 180, 0.85, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "LightBlue", "White", "LightGrey", "Magenta", "Skin16", "Skin17", "Purple", "Skin18", "Blue", "Orange", "Skin19", "Pink"}), 16, -2),
	SW1000("SW1000", DieselSW1000.class, ItemIDs.minecartSW1000.item, "diesel", 1000, 105, 0, 25, 0, 200, 0.85, 0.7, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "Purple", "Yellow", "Skin16", "Skin19", "Skin20", "Magenta", "Skin21", "Skin22", "Brown"}), 16, -2),
	SW1200("SW1200", DieselSW1200.class, ItemIDs.minecartSW1200.item, "diesel", 1200, 105, 0, 25, 0, 200, 0.85, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Lime", "Green", "Black", "Grey", "Yellow", "Pink", "Orange", "Blue", "Purple", "Magenta", "Brown", "LightGrey", "Skin17", "Skin18"}), 16, -2),
	...
	SW1600("SW1600", DieselSW1600.class, ItemIDs.minecartSW1600.item, "diesel", 1600, 105, 0, 25, 0, 200, 0.85, 0.7, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan"}), 16, -2),
	...
	TR4("TR4", DieselTR4.class, ItemIDs.minecartTR4.item, "diesel", 1200, 105, 0, 25, 0, 200, 0.85, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Orange", "Purple", "Cyan", "Magenta", "LightGrey"}), 16, -2),
	TR4B("TR4B", DieselTR4B.class, ItemIDs.minecartTR4B.item, "diesel", 1200, 105, 0, 25, 0, 200, 0.85, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Orange", "Purple", "Cyan", "Magenta", "LightGrey"}), 16, -2),

	Beep("Beep", DieselBeep.class, ItemIDs.minecartBeep.item, "diesel", 1500, 105, 0, 25, 0, 200, 0.89, 0.8, 9000, null, 10, -2.2),

	//GE//
	GE44Ton("GE 44-ton", DieselGE44Ton.class, ItemIDs.minecart44Ton.item, "diesel", 360, 56, 0, 10, 0, 200, 0.7, 0.75, 7000, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Pink", "LightGrey", "Skin16", "Black", "Skin17", "Skin18", "Magenta", "Purple", "Skin19", "Red", "Skin20", "Skin21", "Skin22"}), 18, -2.0),
	...
	U18BB("U18BB", DieselU18BB.class, ItemIDs.minecartU18BB.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Lime", "Skin27"}), 16, -2.5),
	U18BW("U18BW", DieselU18BW.class, ItemIDs.minecartU18BW.item, "diesel", 1800, 120, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "White", "Orange", "Grey", "Lime"}), 16, -2.5),
	U18Balt("U18Balt", DieselU18Balt.class, ItemIDs.minecartU18Balt.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Cyan", "White", "LightGrey", "Skin16", "Skin17", "Skin18", "Lime", "Skin19", "Skin22", "Skin23", "Skin24", "Skin25", "Skin21", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30"}), 16, -2.6),
	...
	U23BU("U23BU", DieselU23BU.class, ItemIDs.minecartU23BU.item, "diesel", 2250, 113, 0, 30, 0, 160, 0.75, 0.86, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Skin16", "Skin17", "White", "Skin18", "LightBlue", "Skin19", "Yellow", "Skin20", "Blue", "Purple", "Pink"}), 14, -3.1),
	...
	SF30B("SF30B", DieselSF30B.class, ItemIDs.minecartSF30B.item, "diesel", 3000, 113, 0, 30, 0, 160, 0.75, 0.86, 25000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Brown", "Skin16", "Blue", "Yellow", "LightBlue", "Orange", "Cyan", "Red"}), 14, -3.1),
	U25B("U25B", DieselU25B.class, ItemIDs.minecartU25B.item, "diesel", 2500, 113, 0, 25, 0, 200, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "LightGrey", "Skin18", "Blue", "Orange", "Pink", "Green", "Skin16", "Red", "Skin17", "Skin19", "Skin20", "Skin21", "Brown"}), 14, -3.3),
	U30BH("U30BH", DieselU30BH.class, ItemIDs.minecartU30BH.item, "diesel", 2950, 188, 0, 35, 0, 180, 0.8, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "LightGrey", "Purple", "Skin17", "Skin18", "Skin19"}), 14, -3.1),
	U36B("U36B", DieselU36B.class, ItemIDs.minecartU36B.item, "diesel", 3600, 121, 0, 20, 0, 180, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Blue", "Grey", "LightGrey", "Skin19", "Skin20", "Skin21", "Skin22", "LightBlue", "Green", "Skin16", "Skin17"}), 14, -3.1),
	U23C("U23C", DieselU23C.class, ItemIDs.minecartU23C.item, "diesel", 2250, 113, 0, 25, 0, 200, 0.7, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Skin17", "LightGrey", "Blue", "Skin24"}), 12, -3.3),
	...
	B23_wrx("B23-7_wrx", DieselB23_wrx.class, ItemIDs.minecartB23_wrx.item, "diesel", 2250, 101, 0, 23, 0, 185, 0.84, 0.92, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Skin16", "Skin17"}), 14, -3.1),
	B23S7("B23-S7", DieselB23S7.class, ItemIDs.minecartB23S7.item, "diesel", 2250, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Grey", "Skin17", "LightGrey", "Cyan", "Green", "Skin18", "Blue"}), 14, -3.1),
	BQ23("BQ23-7", DieselBQ23.class, ItemIDs.minecartBQ23.item, "diesel", 2250, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Red", "Skin17", "LightGrey", "Skin18", "LightBlue", "Pink", "Skin16", "Cyan"}), 14, -3.1),
	...
	B30("B30-7", DieselB30.class, ItemIDs.minecartB30.item, "diesel", 3000, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin34", "Skin31", "Blue", "Skin38", "Skin36", "Skin35", "Skin37", "Skin42" }), 14, -3.1),
	B36("B36-7", DieselB36.class, ItemIDs.minecartB36.item, "diesel", 3600, 113, 0, 20, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin30", "Skin31", "Skin40", "Skin38", "Skin41", "Skin36", "Skin39", "Lime", "Skin16"}), 14, -3.1),
	...
	Dash818BE("Dash818BE", DieselDash818BE.class, ItemIDs.minecartDash818BE.item, "diesel", 1850, 113, 0, 50, 0, 180, 0.8, 0.75, 16000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan"}), 14, -3.1),
	...
	Dash839C("Dash839C", DieselDash839C.class, ItemIDs.minecartDash839C.item, "diesel", 3900, 120, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Grey", "Skin19", "Black", "Blue", "Skin17", "Cyan", "LightGrey", "Skin16", "Brown", "Orange", "Skin18", "Skin20"}), 12, -4.0),
	...
	Dash840B("Dash840B", DieselDash840B.class, ItemIDs.minecartDash840B.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Blue", "Yellow", "Orange", "LightBlue", "Pink", "Purple", "Black"}), 12, -3.6),
	...
	Dash840C("Dash840C", DieselDash840C.class, ItemIDs.minecartDash840C.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.8, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Grey", "LightBlue", "Skin24", "Skin22", "Skin25", "Blue", "Skin16", "LightGrey", "Skin17", "Purple", "Skin23"}), 12, -4),
	Dash841C("Dash841C", DieselDash841C.class, ItemIDs.minecartDash841C.item, "diesel", 4100, 113, 0, 39, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "LightGrey", "Pink", "Orange", "Skin16", "Green", "Skin17", "Lime"}), 12, -4.0),
	...
	AlcoPB1("PB1", DieselPB1.class, ItemIDs.minecartAlcoPB1.item, "diesel", 2000, 188, 0, 25, 0, 200, 0.7, 0.79, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Skin24", "Magenta", "Yellow", "Orange", "LightGrey", "Skin19", "Black"}), 12, -3.1),
	FA1("FA1", DieselFA1.class, ItemIDs.minecartFA1.item, "diesel", 1600, 105, 0, 25, 0, 200, 0.7, 0.79, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Green", "Magenta", "Yellow", "Orange", "Lime", "White", "Purple", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24"}), 15, -2.845),
	...
	FA2("FA2", DieselFA2.class, ItemIDs.minecartFA2.item, "diesel", 1600, 120, 0, 25, 0, 200, 0.7, 0.79, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Yellow", "Blue", "Black", "Orange", "Green", "Purple", "Lime", "LightGrey", "White", "Magenta", "Skin17", "Skin18"}), 15, -2.845),
	...
	FAFDL("FAFDL", DieselFAFDL.class, ItemIDs.minecartFAFDL.item, "diesel", 1800, 120, 0, 30, 0, 200, 0.7, 0.79, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "LightGrey", "Grey"}), 15, -2.845),
	FBFDL("FBFDL", DieselFBFDL.class, ItemIDs.minecartFBFDL.item, "diesel", 1800, 120, 0, 30, 0, 200, 0.7, 0.79, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "LightGrey", "Grey"}), 15, -2.825),

	RS1("RS1", DieselRS1.class, ItemIDs.minecartRS1.item, "diesel", 1000, 105, 0, 30, 0, 200, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Blue", "Green", "LightGrey", "Skin17", "Skin18", "Cyan", "LightBlue", "Purple", "Skin19", "White"}), 16, -2.5),
	RS2("RS2", DieselRS2.class, ItemIDs.minecartRS2.item, "diesel", 1500, 105, 0, 28, 0, 200, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "LightGrey", "LightBlue", "White", "Magenta", "Brown", "Skin19", "Skin23", "Black"}), 16, -2.5),
	RS3("RS3", DieselRS3.class, ItemIDs.minecartRS3.item, "diesel", 1600, 137, 0, 28, 0, 200, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "LightGrey", "Yellow", "Magenta", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26"}), 16, -2.5),
	...
	C415H("C415H", DieselC415H.class, ItemIDs.minecartC415H.item, "diesel", 1500, 106, 0, 35, 0, 200, 0.87, 0.93, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Magenta", "Brown", "Red", "Pink", "Green", "Cyan"}), 16, -2.4),
	...
	C424("C424",DieselC424.class, ItemIDs.minecartC424.item, "diesel", 2400, 113, 0, 40, 0, 200, 0.7, 0.8, 18000, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Red", "Black", "Pink", "Brown", "Magenta", "Skin17", "LightGrey", "Skin16", "Skin18", "Skin19", "Cyan", "Green", "Purple", "Skin20"}), 14, -2.8),
	...
	HH660("HH660", DieselHH660.class, ItemIDs.minecartHH660.item, "diesel", 660, 50, 0, 15, 0, 200, 0.9, 0.95, 6000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Orange", "Black", "Red", "Cyan", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21"}), 16, -2),
	S2("S2",  DieselS2.class, ItemIDs.minecartS2.item, "diesel", 1000, 96, 0, 15, 0, 200, 0.7, 0.965, 6000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Green", "Orange", "Pink", "White", "Blue", "LightGrey", "Magenta", "Red", "Skin16", "Skin17", "Skin18"}), 16, -2),
	...
	M420("M420", DieselM420.class, ItemIDs.minecartM420.item, "diesel", 2000, 108, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Lime", "Pink", "Cyan", "Grey", "Purple"}), 15, -2.8),
	...
	M630("M630", DieselM630.class, ItemIDs.minecartM630.item, "diesel", 3000, 120, 0, 15, 0, 190, 0.7, 0.8, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Skin17", "LightGrey", "Cyan", "Purple", "Brown"}), 12, -3.45),
	...
	DS441000("DS441000", DieselDS441000.class, ItemIDs.minecartDS441000.item, "diesel", 1000, 97, 0, 35, 0, 180, 0.75, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Green", "Grey", "Black", "Orange","Skin20"}), 16, -2.2),
	...
	DR441500Phase2("DR441500Phase2", DieselDR441500Phase2.class, ItemIDs.minecartDR441500Phase2.item, "diesel", 1500, 105, 0, 25, 0, 200, 0.7, 0.79, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "LightGrey", "Yellow", "Red", "White", "Grey", "Magenta", "Purple", "Skin16"}), 15, -2.845),
	...
	TB27("TB27",DieselTB27.class, ItemIDs.minecartTB27.item, "diesel", 2700, 110, 0, 40, 0, 200, 0.7, 0.8, 18000, TraincraftUtil.getBytesFromColors(new String[]{"Red", "LightGrey", "White", "Purple"}), 14, -2.8),
	...
	//FrERf//
	RoundHopper("Freight Round Covered Hopper", RoundHopper.class, ItemIDs.minecartRoundHopper.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Red", "Black", "White", "LightGrey"}), 15, 36,(new String[] {"Cargo: Any."})),
	RibbedHopper("Freight Ribbed Covered Hopper", RibbedHopper.class, ItemIDs.minecartRibbedHopper.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "Cyan", "LightGrey", "Red", "Brown", "White", "Pink", "Skin16", "Orange", "Skin20", "Skin17", "Skin18", "Skin19", "Skin21", "Green", "Skin22"}), 15, 36,(new String[] {"Cargo: Any."})),
	Hopper5201("5201 Cu Foot Hopper", Hopper5201.class, ItemIDs.minecartHopper5201.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "Cyan", "Black", "Skin16", "Skin17", "LightGrey", "Blue", "Skin18", "Skin19", "Skin20"}), 15, 36,(new String[] {"Cargo: Any."})),
	Hopper6260("6260 Cu Foot Jumbo Hopper", Hopper6260.class, ItemIDs.minecartHopper6260.item, "Covered Hopper", 4, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "LightGrey", "White", "Brown", "Skin16", "Skin17"}), 14, 45,(new String[] {"Cargo: Any."})),
	FNCC2375Hopper("FNCC2375Hopper", FNCC2375Hopper.class, ItemIDs.minecartFNCC2375Hopper.item, "Covered Hopper", 2.5, TraincraftUtil.getBytesFromColors(new String[]{"Cyan", "Green", "Black", "LightGrey", "Blue", "Skin16", "Skin17", "Purple", "Magenta", "Pink", "Yellow", "Red", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22"}), 15, 27,(new String[] {"Cargo: Any."})),
	PDH2800("PDH2800", PDH2800.class, ItemIDs.minecartPDH2800.item, "Covered Hopper", 2, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey","Yellow","Grey","Brown","Magenta", "Skin16", "Skin17"}), 18, 27,(new String[] {"Cargo: Any."})),
	ACF2Bay("ACF2Bay", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACF2Bay.class, ItemIDs.minecartACF2Bay.item, "Covered Hopper", 2.5, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "Black", "Magenta", "Skin16", "Grey", "Red", "Orange", "Skin17", "Skin18", "Blue", "Skin19", "Skin20", "Brown"}), 15, 27,(new String[] {"Cargo: Any."})),
	ACF4650("ACF4650", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACF4650.class, ItemIDs.minecartACF4650.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Skin18", "Grey", "LightGrey", "Skin16", "Skin17", "Brown", "White", "Skin19", "Blue", "Orange", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Skin32", "Purple"}), 15, 36,(new String[] {"Cargo: Any."})),
	PS2_4750("PS2_4750", PS2_4750.class, ItemIDs.minecartPS2_4750.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "White", "Skin17", "Skin18", "Skin16", "Skin20", "Grey", "Skin19", "LightBlue", "Skin21", "Yellow", "Skin22", "Orange", "Magenta", "Green", "Lime", "Purple", "Skin23", "Cyan", "Brown", "Pink", "Skin24", "Skin25", "Skin28", "Skin27", "Skin29", "Skin30", "Skin31", "Skin32", "Skin33", "Black", "Skin34", "Blue", "Skin35", "Skin36", "Skin37", "Skin38", "Skin39", "Skin40", "Skin41", "Skin42", "Skin43", "Skin44"}), 15, 36,(new String[] {"Cargo: Any."})),
	GATC4180Airslide("GATC4180Airslide", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.GATC4180Airslide.class, ItemIDs.minecartGATC4180Airslide.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Grey", "Skin17", "LightGrey", "Skin18", "Skin21", "Skin19", "Green", "Orange", "Yellow", "Skin20", "Pink", "Magenta", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27"}), 15, 36,(new String[] {"Cargo: Any."})),
	ACF3500("ACF3500", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACF3500.class, ItemIDs.minecartACF3500.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "Yellow", "Skin17", "Pink", "Skin18", "Brown", "Skin19", "Orange", "Black", "LightGrey", "Skin20", "Skin21", "Skin22", "Skin23"}), 15, 36,(new String[] {"Cargo: Any."})),
	ACF3960("ACF3960", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACF3960.class, ItemIDs.minecartACF3960.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "Green", "White", "Skin16", "Skin17", "Skin18", "Grey"}), 15, 36,(new String[] {"Cargo: Any."})),

	Freight60centerbeam("60centerbeam",  com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight60centerbeam.class, ItemIDs.minecart60centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Yellow", "Green", "LightGrey"}), 10, 54, (new String[] {"Cargo: Woodthings."})),
	Freight66centerbeam("66centerbeam",  com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight66centerbeam.class, ItemIDs.minecart66centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Cyan", "Black", "Green", "Lime", "Red", "Purple", "LightBlue", "Pink", "Blue", "Yellow"}), 10, 54, (new String[] {"Cargo: Woodthings."})),
	Freight73centerbeam("73centerbeam",  com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight73centerbeam.class, ItemIDs.minecart73centerbeam.item, "Centerbeam Flat", 3.5, TraincraftUtil.getBytesFromColors(new String[] {"Pink", "Cyan", "Green", "Orange", "Yellow", "Red", "Purple"}), 10, 54, (new String[] {"Cargo: Woodthings."})),
	GSI60FootBulkhead("GSI_Bulkhead", GSI60FootBulkhead.class, ItemIDs.minecartGSI60FootBulkhead.item, "Bulkhead Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Skin16", "Green", "Black", "Skin17", "Brown", "Cyan"}), 10, 45, (new String[] {"Cargo: Bulkhead Items."})),
	GSC60FootFlatcar("GSC_Flatcar", GSC60FootFlat.class, ItemIDs.minecartGSC60FootFlatcar.item, "Flatcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Orange", "Yellow", "Skin17", "Brown", "Green", "Skin16"}), 12, 45, (new String[] {"Cargo: whatever flatcars carry i guess"})),
	Thrall63centerbeam("63centerbeam",  Thrall63centerbeam.class, ItemIDs.minecartthrall63centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Yellow", "Red", "Black", "Cyan", "Skin16", "Skin17", "Purple"}), 12, 45, (new String[] {"Cargo: Woodthings."})),
	FNCC60FootBulk("FNCC60FootBulk", FNCC60FootBulk.class, ItemIDs.minecartFNCC60FootBulk.item, "Bulkhead Flat", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Green", "Yellow", "Skin16", "Skin17", "Lime", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22"}), 12, 45, (new String[] {"Cargo: Bulkhead Stuff."})),
	GSC53FootFlatcar("GSC_53Flatcar", GSC53FootFlat.class, ItemIDs.minecartGSC53FootFlatcar.item, "Flatcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Brown", "Green", "Lime", "Black", "White", "Grey", "LightGrey"}), 12, 45, (new String[] {"Cargo: whatever flatcars carry i guess"})),
	GSC53Foot6_6Bulkhead("GSC_53_66Bulkhead", GSC53Foot66Bulkhead.class, ItemIDs.minecartGSC5366FootBulkhead.item, "Bulkhead Flat", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Red", "Black", "Grey", "Blue"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),
	GSC53Foot8_6Bulkhead("GSC_53_86Bulkhead", GSC53Foot86Bulkhead.class, ItemIDs.minecartGSC5386FootBulkhead.item, "Bulkhead Flat", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Green", "Red", "Purple", "Black", "Lime", "White", "Grey", "Yellow"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),
	MaPa35FootFlatcar("MaPa_35Flatcar", MaPa35FootFlat.class, ItemIDs.minecartMaPa35FootFlatcar.item, "Flatcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Grey","Magenta", "LightGrey", "Black", "Green", "Lime", "Orange", "Purple", "Red"}), 12, 18, (new String[] {"Cargo: whatever flatcars carry i guess"})),

	PS140("PS140", PS140.class, ItemIDs.minecartPS140.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "LightBlue", "Green", "Cyan", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Yellow", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Magenta", "Skin26", "Skin27", "Skin28", "Orange"}), 15, 27, (new String[] {"Cargo: Any."})),
	PS150("PS150", PS150.class, ItemIDs.minecartPS150.item, "Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"White", "Lime", "Red", "Yellow", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Brown", "Cyan", "Skin21", "Skin22", "Skin23"}), 14, 36, (new String[] {"Cargo: Any."})),
	PS160("PS160", PS160.class, ItemIDs.minecartPS160.item, "Boxcar", 3.25, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Orange", "Cyan", "White"}), 13, 45, (new String[] {"Cargo: Any."})),
	OWO60Verticube("OWO 60 Verticube", OWO60Verticube.class, ItemIDs.minecartOWO60Verticube.item, "Highcube Boxcar", 3.75, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Lime", "Green", "Brown", "White", "Pink", "Purple", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Yellow", "Skin25"}), 10, 54, (new String[] {"Cargo: Any."})),
	MILW40boxcar("MILW40boxcar", MILW40boxcar.class, ItemIDs.minecartMILW40boxcar.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Brown", "Yellow", "Green", "Blue", "Purple", "Orange", "Lime"}), 15, 27, (new String[] {"Cargo: Any."})),
	Freight40highcube("40highcube", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.Freight40highcube.class, ItemIDs.minecart40highcube.item, "Highcube Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Green", "Cyan", "Orange", "Grey", "Red", "Lime", "LightGrey", "Pink", "Purple", "Blue", "Black", "White", "Magenta", "Skin16", "Skin17","Skin18"}), 15, 40, (new String[] {"Cargo: Any."})),
	Hicube60("60 Foot Hi-Cube Boxcar", Hicube60foot.class, ItemIDs.minecarthicube60foot.item, "Highcube Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "Pink", "Blue", "Skin16", "Skin17", "Lime", "White", "Cyan", "Green", "Purple", "Skin18"}), 12, 54, (new String[] {"Cargo: Any."})),
	Reefer64("Reefer64", Reefer64Foot.class, ItemIDs.minecartReefer64.item, "Refrigerated Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"White", "LightGrey", "Grey", "Orange", "Green", "Red", "Black", "Cyan", "Skin16", "Skin17"}), 10, 54, (new String[] {"Cargo: Any."})),
	FNCC50Foot("FNCC50FootBoxcar",  FNCC50Foot.class, ItemIDs.minecartFNCC50Foot.item, "Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Green", "Black", "Skin18", "Skin19", "Brown", "Pink", "Skin16", "Blue", "Skin23", "Skin22", "Skin21", "Yellow", "White", "Skin17", "Magenta", "Skin24", "Skin25", "Skin26"}), 16, 36, (new String[] {"Cargo: Any."})),
	GN40("GN40",  GN40.class, ItemIDs.minecartGN40.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Red"}), 16, 27, (new String[] {"Cargo: Any."})),
	R70Reefer("R70Reefer", R70Reefer.class, ItemIDs.minecartR70Reefer.item, "Refrigerated Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "LightGrey", "Cyan", "White", "Yellow", "Skin16", "Orange", "Skin17", "Skin18", "Green", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31"}), 10, 54, (new String[] {"Cargo: Cold Stuff lol"})),
	R70Reefer2("R70Reefer2", R70Reefer2.class, ItemIDs.minecartR70Reefer2.item, "Refrigerated Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "White", "Orange", "Skin19", "Yellow", "Red", "Skin20", "Skin21"}), 10, 54, (new String[] {"Cargo: Cold Stuff lol"})),
	NSCReefer("NSCReefer",  NSCReefer.class, ItemIDs.minecartNSCchildHUH.item, "Refrigerated Boxcar", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "LightGrey", "Orange"}), 16, 36, (new String[] {"Cargo: meet and HUH!?"})),
	PCF6033("PCF6033", PCF6033.class, ItemIDs.minecartPCF6033.item, "Highcube Boxcar", 3.75, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Skin16", "Pink", "Blue", "Red", "Skin17", "Yellow", "Magenta", "Cyan", "Skin18", "Skin19", "LightGrey", "Skin20", "Skin21", "Skin22"}), 10, 54, (new String[] {"Cargo: Any."})),
	PCF_RBL_Smooth("PCF_RBL_Smooth", PCF_RBL_Smooth.class, ItemIDs.minecartPCF_RBL_Smooth.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Brown", "Skin16", "Skin17", "Skin29", "Green", "Cyan", "Skin22", "Skin18", "Skin19", "Skin20", "Skin21", "Yellow", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28"}), 10, 45, (new String[] {"Cargo: Any."})),
	PCF_RBL_Ribbed("PCF_RBL_Ribbed", PCF_RBL_Ribbed.class, ItemIDs.minecartPCF_RBL_Ribbed.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Blue", "Red", "Pink", "Grey", "Magenta", "Lime", "Orange", "Brown", "White", "Yellow", "Black", "LightGrey"}), 10, 45, (new String[] {"Cargo: Any."})),
	PCF_B100("PCF_B100", PCF_B100.class, ItemIDs.minecartPCF_B100.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Skin16", "Grey", "Green", "LightGrey", "Skin17"}), 10, 45, (new String[] {"Cargo: Any."})),
	ACFRailbox("ACF Railbox", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACFRailbox.class, ItemIDs.minecartACFRailbox.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "Blue", "Black", "Orange", "Pink", "LightBlue", "White", "Magenta", "Cyan", "Grey"}), 12, 54, (new String[] {"Cargo: Any."})),
	ACFRailboxCushioned("ACF Railbox (Cushioned)", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACFRailboxCushioned.class, ItemIDs.minecartACFRailboxCushioned.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Lime", "White", "Brown", "Red", "Blue", "Grey", "Orange", "Yellow","Skin16"}), 12, 54, (new String[] {"Cargo: Any."})),
	Evans5100("Evans5100", Evans5100.class, ItemIDs.minecartEvans5100.item, "Boxcar", 4.5, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Green", "Orange", "Red", "Skin16", "Pink", "Cyan", "Blue", "Yellow", "Brown", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Purple", "Magenta", "Skin22", "Skin23", "Skin24", "LightGrey", "Black", "Skin25", "White", "Skin26", "Skin27", "Grey"}), 12, 54, (new String[] {"Cargo: Any."})),
	Wood1912Boxcar("1912WoodBoxcar", Wood1912Boxcar.class, ItemIDs.minecart1912WoodBoxcar.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Magenta", "Red", "Yellow", "Green"}), 15, 27, (new String[] {"Cargo: Any."})),
	PS_40t_ss_box("PS_40t_ss_box",  PS_40t_ss_box.class, ItemIDs.minecartPS_40t_ss_box.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Green", "Lime", "Brown", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20"}), 16, 27, (new String[] {"Cargo: Any."})),
	SP_B50("SP_B50",  SP_B50.class, ItemIDs.minecartSP_B50.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Magenta", "Brown", "Orange", "Green", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20"}), 16, 27, (new String[] {"Cargo: Any."})),
	SP_B50_AAR("SP_B50_AAR",  SP_B50_AAR.class, ItemIDs.minecartSP_B50_AAR.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Red","Skin17","Skin18","Skin19","Skin20","Skin21","Skin22","Skin23","Skin24","Skin25","Skin33","Skin26","Skin27","Skin28","Skin29","Skin30","Skin31","Skin34","Skin32","Skin35"}), 16, 27, (new String[] {"Cargo: Whatever a boxcar can hold."})),
	PFEr_40_23Reefer("PFEr_40_23Reefer",  PFEr_40_23Reefer.class, ItemIDs.minecartPFEr_40_23Reefer.item, "Refrigerated Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Red", "Brown", "Yellow", "Purple", "Grey"}), 16, 27, (new String[] {"Cargo: Cold Things you Dumbass."})),

	VersaLongi("VersaLongi", VersaLongi.class, ItemIDs.minecartVersaLongi.item, "Open Top Hopper", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Black", "Orange", "Brown", "Skin16", "Grey", "Pink", "LightBlue", "Yellow"}), 15, 36, (new String[] {"Cargo: Aggregates."})),
	VersaTrans("VersaTrans", VersaTrans.class, ItemIDs.minecartVersaTrans.item, "Open Top Hopper", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Grey", "LightGrey", "Black"}), 15, 36, (new String[] {"Cargo: Aggregates."})),
	MillGondola("52footMillGondola", MillGondola.class, ItemIDs.minecartMillGondola.item, "Gondola", 3, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Black", "Orange", "Green", "Grey", "Skin16", "Skin18", "Blue", "Lime", "Skin17", "Brown", "Pink", "LightGrey", "Skin19", "Yellow"}), 14, 45, (new String[] {"Cargo: Any."})),
	WoodchipHopper("Woodchip Hopper", WoodchipHopper.class, ItemIDs.minecartWoodchipHopper.item, "Open Top Hopper", 3, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Blue", "Green", "Orange", "Red", "White", "Cyan", "Skin18", "Skin19", "Skin16", "Skin17"}), 14, 45, (new String[] {"Cargo: Woodchips/Sawdust."})),
	OreJenny("Ore Jenny", OreJenny.class, ItemIDs.minecartOreJenny.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "Orange", "Pink", "Black"}), 18, 27, (new String[] {"Cargo: Ores."})),
	PRRGLaHopper("PRR GLa hopper", PRRGLaHopper.class, ItemIDs.minecartPRRGLaHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Black", "Yellow", "Magenta", "Blue", "LightGrey"}), 16, 27, (new String[] {"Cargo: Ores."})),
	ACF41Gon("ACF41Gon", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACF41Gon.class, ItemIDs.minecartACF41Gon.item, "Gondola", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Black", "Grey", "Brown", "Skin16"}), 15, 27, (new String[] {"Cargo: Gonstuff"})),
	BethgonII("BethgonII", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.BethgonII.class, ItemIDs.minecartBethgonII.item, "Open Top Hopper", 4, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "Orange", "Yellow", "Grey", "Magenta", "Pink", "Purple", "Skin16", "Skin17"}), 14, 45, (new String[] {"Cargo: Coal n shid"})),
	gsco67millgon("67millgon", gsco67millgon.class, ItemIDs.minecart67millgon.item, "Gondola", 3.5, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Green", "Brown", "Blue", "Grey", "Skin16", "Skin17", "Purple", "Skin18"}), 12, 45, (new String[] {"Cargo: Any."})),
	gsco52millgon("52millgon", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.gsco52millgon.class, ItemIDs.minecart52millgon.item, "Gondola", 3.0, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Lime", "Red", "Skin16", "Black", "Grey", "Purple", "Brown", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21"}), 12, 45, (new String[] {"Cargo: Any."})),
	AAR50TonHopper("AAR 50 Ton Hopper", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.AAR50TonHopper.class, ItemIDs.minecartAAR50TonHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Purple", "Skin16"}), 16, 27, (new String[] {"Cargo: Ores."})),
	AAR70TonHopper("AAR 70 Ton Hopper", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.AAR70TonHopper.class, ItemIDs.minecartAAR70TonHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Magenta", "Skin16", "Skin17", "Skin18"}), 16, 27, (new String[] {"Cargo: Ores."})),
	MaPa35FootGondola("MaPa_35Gondola", MaPa35FootGondola.class, ItemIDs.minecartMaPa35FootGondola.item, "Gondola", 3.0, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Grey"}), 12, 27, (new String[] {"Cargo: Any."})),

	DOT11111000( "DOT11000", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11111000.class, ItemIDs.minecart11000DOT111.item, "Tankcar", 0, 0, 2.25, 0, 0, 0, 0, 0, 41000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "LightGrey", "Grey"}), 16, 0),
	DOT11120600( "DOT20600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11120600.class, ItemIDs.minecart20600DOT111.item, "Tankcar", 0, 0, 3, 0, 0, 0, 0, 0, 78000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Black", "White", "Green", "LightGrey"}), 14, 0),
	DOT11129080( "DOT29080", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11129080.class, ItemIDs.minecart29080DOT111.item, "Tankcar", 0, 0, 3.25, 0, 0, 0, 0, 0, 110000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Orange", "LightGrey", "White", "Grey", "Skin16", "Skin17", "Skin18"}), 12, 0),
	DOT11117600( "DOT17600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11117600.class, ItemIDs.minecart17600DOT111.item, "Tankcar", 0, 0, 2.5, 0, 0, 0, 0, 0, 67000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Blue", "LightGrey", "Grey", "Yellow", "Brown", "Purple", "Skin16", "Skin17", "Skin18"}), 16, 0),
	NATX30600( "NATX30600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.NATX30600.class, ItemIDs.minecartNATX30600.item, "Tankcar", 0, 0, 3.25, 0, 0, 0, 0, 0, 116000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Green", "Red", "Yellow", "Pink", "Skin16", "Skin17", "LightBlue", "Skin18"}), 12, 0),
	gatc10000( "gatc10000", GATC10000.class, ItemIDs.minecartgatc10000.item, "Tankcar", 0, 0, 2, 0, 0, 0, 0, 0, 38000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin16", "Skin17", "LightBlue", "Grey", "Skin18", "Skin19"}), 15, 0),
	DUPX39200( "DUPX39200", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DUPX39200.class, ItemIDs.minecartDUPX39200.item, "Tankcar", 0, 0, 5, 0, 0, 0, 0, 0, 148000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "White", "Green", "Black"}), 10, 0),

	CoffinCar( "CoffinCar", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.CoffinCar.class, ItemIDs.minecartCoffinCar.item, "Tankcar", 0, 0, 1.5, 0, 0, 0, 0, 0, 16000, TraincraftUtil.getBytesFromColors(new String[] {"Black"}), 14, 0),
	SkeletonCar("Skeleton", SkeletonLogCar.class, ItemIDs.minecartSkeletonLogCar.item, "Log Flat", 1, TraincraftUtil.getBytesFromColors(new String[]{"Black","Grey", "LightGrey"}), 18, 18, (new String[] {"Cargo: Logs."})),
	EarlyFlat("EarlyFlat", EarlyFlat.class, ItemIDs.minecartEarlyFlat.item, "Flatcar",0.7, null, 18, 18, (new String[] {"Cargo: Any."})),
	...
	PSRPO("PSRPO", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.PSRPO.class, ItemIDs.minecartPSRPO.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Blue", "Cyan", "Orange"}), 12, 27,null),
	PS85Baggage("Freight PS 85 Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.PS85Baggage.class, ItemIDs.minecartPS85Baggage.item, "freight", 2, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Blue", "Orange"}), 10, 27, null),
	PSCombine("PS Combine Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSCombine.class, ItemIDs.minecartPScombine.item, "passenger/combine", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Yellow", "Orange", "LightGrey", "Grey", "White", "Red"}), 10, 0, 18, null),
	...
	DRGWRPO620Series("D&RGW RPO 620 Series", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.DRGWRPO620Series.class, ItemIDs.minecartDRGWRPO620Series.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Magenta", "Green", "Lime", "Grey", "Purple", "Yellow"}), 12, 27,null),
	DRGWRPO630Series("D&RGW RPO 630 Series", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.DRGWRPO630Series.class, ItemIDs.minecartDRGWRPO630Series.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Yellow"}), 12, 27,null),
	DRGWBaggage700Series("D&RGW Baggage 700 Series", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.DRGWBaggage700Series.class, ItemIDs.minecartDRGWBaggage700Series.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Magenta", "Green", "Lime", "Brown", "Yellow", "Black", "Grey", "LightGrey", "White", "Orange", "Purple"}), 12, 27,null),
	DRGWBaggage740Series("D&RGW Baggage 740 Series", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.DRGWBaggage740Series.class, ItemIDs.minecartDRGWBaggage740Series.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Black", "Brown", "Yellow", "Grey", "Magenta", "LightGrey", "White"}), 12, 27,null),
	DRGWCoach1000Series("D&RGW Coach 1000 Series", DRGWCoach1000Series.class, ItemIDs.minecartDRGWCoach1000Series.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Blue", "Black", "Yellow", "Grey"}), 12, 0),
	DRGWCoach1005Series("D&RGW Coach 1005 Series", DRGWCoach1005Series.class, ItemIDs.minecartDRGWCoach1005Series.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Orange", "Black", "Grey", "LightGrey", "White", "Brown", "Red"}), 12, 0),

	PSRPOPM("PSPMRPO", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.PSRPOPM.class, ItemIDs.minecartPSRPOPM.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Yellow"}), 12, 27,null),
	PS73Baggage("Freight PS 73 Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.PS73Baggage.class, ItemIDs.minecartPS73Baggage.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Yellow", "Green", "Red", "Magenta", "Orange"}), 12, 27, null),
	PS54SeatCoach_Lounge("PS 54 Seat Coach-Lounge", PS54SeatCoach_Lounge.class, ItemIDs.minecartPS54SeatCoach_Lounge.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Cyan", "LightBlue", "LightGrey", "Grey"}), 10, 0, null),
	...
	PSBMCombine("PS B&M Combine", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSBMCombine.class, ItemIDs.minecartPSBMCombine.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Magenta", "Brown", "Green", "Blue"}), 10, 0, 18,null),
	...
	ACFGNRPO_30("AC&F GN RPO (30' mail)", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.ACFGNRPO_30.class, ItemIDs.minecartACFGNRPO_30.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Yellow", "Green", "Lime"}), 10, 27,null),
	ACFGN60SeatCoach("AC&F GN 60 Seat Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.ACFGN60SeatCoach.class, ItemIDs.minecartACFGN60SeatCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Yellow", "Brown", "LightBlue", "Green", "LightGrey", "Black", "White", "Cyan", "Blue", "Lime", "Grey", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21"}), 10, 0, null),
	...
	ACFGN28SeatCoach_Dinette("AC&F GN 28 Seat Coach-Dinette", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.ACFGN28SeatCoach_Dinette.class, ItemIDs.minecartACFGN28SeatCoach_Dinette.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Green", "Blue", "White"}), 10, 0, null),
	...
	PSGNRPO_30("PS GN RPO (30' mail)", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.PSGNRPO_30.class, ItemIDs.minecartPSGNRPO_30.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Green", "Yellow", "Lime"}), 10, 27,null),
	...
	OBBaggage_52SeatDividedCoach("OB Baggage-52 Seat Divided Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.OBBaggage_52SeatDividedCoach.class, ItemIDs.minecartOBBaggage_52SeatDividedCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Green", "LightGrey", "Lime", "Grey", "Yellow"}), 10, 0, 18, null),
	...
	OBRPO15("OB RPO (15' mail)", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.OBRPO15.class, ItemIDs.minecartOBRPO15.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Grey", "Cyan", "LightGrey", "Blue"}), 12, 27,null),
	...
	PSCNWRPO15("PS CNW RPO(15')", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.PSCNWRPO15.class, ItemIDs.minecartPSCNWRPO15.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Green"}), 10, 27,null),
	PSCNWRPO60("PS CNW RPO(60')", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.PSCNWRPO60.class, ItemIDs.minecartPSCNWRPO60.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Green", "Orange", "Red", "Grey", "LightGrey", "White", "Magenta", "Brown", "Lime"}), 10, 27,null),
	PSCNWBaggage_LC_Lounge("PS CNW Baggage-LC-Lounge", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSCNWBaggage_LC_Lounge.class, ItemIDs.minecartPSCNWBaggage_LC_Lounge.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Black", "Green", "Lime", "Grey", "LightGrey", "White", "Magenta"}), 10, 0, 18,null),
	PSCNWRPO15_Baggage_LC_Lounge("PS CNW RPO(15')-Baggage-LC-Lounge", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSCNWRPO15_Baggage_LC_Lounge.class, ItemIDs.minecartPSCNWRPO15_Baggage_LC_Lounge.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Black", "Green", "Lime", "Grey", "LightGrey"}), 10, 0, 18, null),
	PSCNWBaggage_LC_Diner("PS CNW Baggage-LC-Diner", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSCNWBaggage_LC_Diner.class, ItemIDs.minecartPSCNWBaggage_LC_Diner.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Black", "Green", "Lime", "Grey"}), 10, 0, 18, null),
	...
	BuddPrewarBaggage("Budd Prewar Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.BuddPrewarBaggage.class, ItemIDs.minecartBuddPrewarBaggage.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "LightGrey", "White", "Red", "Yellow", "Black"}), 12, 27, null),
	...
	ACF_SP_98seatcoach("AC&F SP 98 Seat Coach", ACF_SP_98seatcoach.class, ItemIDs.minecartACF_SP_98seatcoach.item, "passenger", 0, 0, 5, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "LightGrey", "Grey", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20","Skin21","Skin22"}), 10, 0, null),

	ACFUPRPO60("AC&F UP RPO(60')", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.ACFUPRPO60.class, ItemIDs.minecartACFUPRPO60.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Red", "Orange", "Brown", "Green", "Blue", "Lime", "Grey", "LightGrey", "Black", "White"}), 10, 27,null),
	...
	PSCEIRPO15_Baggage_LC_Lounge("PS C&EI RPO(15')-Baggage-LC-Lounge", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSCEIRPO15_Baggage_LC_Lounge.class, ItemIDs.minecartPSCEIRPO15_Baggage_LC_Lounge.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Orange", "Cyan", "Red"}), 10, 0, 18, null),
	PSCEIRPO15_Baggage_38SeatCoach("PS C&EI RPO(15')-Baggage-38 Seat Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSCEIRPO15_Baggage_38SeatCoach.class, ItemIDs.minecartPSCEIRPO15_Baggage_38SeatCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Orange", "Cyan", "Red"}), 10, 0, 18, null),
	...
	OBHWNH5570_5589Baggage("OB HW NH 5570-5589 Series Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.OBHWNH5570_5589Baggage.class, ItemIDs.minecartOBHWNH5570_5589Baggage.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Yellow", "Grey", "LightGrey", "Black", "Red"}), 12, 27,null),
	...
	NSCCNBaggage("NSC CN Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.NSCCNBaggage.class, ItemIDs.minecartNSCCNBaggage.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Yellow", "LightBlue", "Black", "Lime", "Orange", "Red", "Pink", "Grey", "LightGrey", "Brown", "White", "Blue", "Cyan", "Purple", "Magenta", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20"}), 12, 27, null),

	PSSOUBaggage("PS SOU Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.PSSOUBaggage.class, ItemIDs.minecartPSSOUBaggage.item, "freight", 2, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "LightGrey", "White", "Black", "Brown", "Magenta"}), 10, 27, null),
	PSSOURPO_30("PS SOU RPO (30' mail)", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.PSSOURPO_30.class, ItemIDs.minecartPSSOURPO_30.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "LightGrey", "White", "Black"}), 10, 27,null),

	PRECOPendulumCoach("PRECO Pendulum Coach", PRECOPendulumCoach.class, ItemIDs.minecartPRECOPendulumCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Black", "White", "Grey", "LightGrey", "Magenta", "LightBlue", "Cyan", "Lime", "Orange", "Green", "Red"}), 10, 0, null),

	PSFNCCBaggage_Dinette("PS FNCC Baggage-Dinette", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.PSFNCCBaggage_Dinette.class, ItemIDs.minecartPSFNCCBaggage_Dinette.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Green"}), 10, 0, null),
	...
	MILWPrewarBaggage("MILW Prewar Baggage", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.baggagecar.MILWPrewarBaggage.class, ItemIDs.minecartMILWPrewarBaggage.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey", "Pink", "Lime", "Yellow", "LightBlue", "Magenta", "Orange", "White", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30"}), 12, 27, null),
	MILW1935Baggage_Dinette("MILW 1935 Baggage-Dinette", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.MILW1935Baggage_Dinette.class, ItemIDs.minecartMILW1935Baggage_Dinette.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black"}), 12, 0, 18,null),
	MILW1935Tap_Dinette("MILW 1935 Tap-Dinette", MILW1935Tap_Dinette.class, ItemIDs.minecartMILW1935Tap_Dinette.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey"}), 12, 0, null),
	MILW1935_48SeatCoach("MILW 1935 48 Seat Coach", MILW1935_48SeatCoach.class, ItemIDs.minecartMILW1935_48SeatCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey", "Pink", "Lime"}), 10, 0, null),
	MILW1935_22SeatParlor("MILW 1935 22 Seat Parlor", MILW1935_22SeatParlor.class, ItemIDs.minecartMILW1935_22SeatParlor.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green"}), 10, 0, null),
	MILW1935_21SeatParlor_Observation("MILW 1935 21 Seat Parlor Observation", MILW1935_21SeatParlor_Observation.class, ItemIDs.minecartMILW1935_21SeatParlor_Observation.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple"}), 10, 0, null),
	MILW1935_44SeatCoach_Observation("MILW 1935 44 Seat Coach Observation", MILW1935_44SeatCoach_Observation.class, ItemIDs.minecartMILW1935_44SeatCoach_Observation.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black"}), 10, 0, null),
	MILW1935Dorm_56SeatCoach("MILW 1935 Dormitory-56 Seat Coach", MILW1935Dorm_56SeatCoach.class, ItemIDs.minecartMILW1935Dorm_56SeatCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey"}), 10, 0, null),

	ACF_LN_KCS60SeatDividedCoach("AC&F L&N and KCS 60 Seat Divided Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.ACF_LN_KCS60SeatDividedCoach.class, ItemIDs.minecartACF_LN_KCS60SeatDividedCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple"}), 10, 0, null),
	LNCoach2551Series("L&N Coach 2551 Series", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.LNCoach2551Series.class, ItemIDs.minecartLNCoach2551Series.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey"}), 10, 0, null),

	ACF_MON_LightweightCoach("Monon 21 Series Lightweight Coach", MON_LightweightCoach.class, ItemIDs.minecartMON_lightweightCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey", "Pink"}), 10, 0, null),
	...
	Class74("Class74",ElectricClass74.class, ItemIDs.minecartClass74.item, "electric", 2426, 140, 0, 50, 0, 10, 0.6, 0.7, 13, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Purple", "Red", "Skin16", "Skin17"}), 10, -2, (new String[] {"Not BAP, but gets to be included"})),
	TwoBil("TwoBil",ElectricTwoBil.class, ItemIDs.minecartTwoBil.item, "electric", 428, 121, 0, 7, 0, 0, 0.5, 0.9, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey"}), 11, -3.15, (new String[] {"Not BAP, but gets to be included"})),
	TwoBilTail("TwoBilTail", PassengerTwoBilTail.class, ItemIDs.minecartTwoBilTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey"}), 11, 0, (new String[] {"Not BAP, but gets to be included"})),
	FourCor("FourCor",ElectricFourCor.class, ItemIDs.minecartFourCor.item, "electric", 900, 121, 0, 7, 0, 0, 0.5, 0.9, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey"}), 11, -3.6, (new String[] {"Not BAP, but gets to be included"})),
	FourCorTrailerComposite("FourCorTrailerComposite", PassengerFourCorTrailerComposite.class, ItemIDs.minecartFourCorTrailerComposite.item, "passenger", 0, 0, 1.6, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Purple", "LightGrey", "Grey"}), 11, 0, (new String[] {"Not BAP, but gets to be included"})),
	...
	CQ310PA("CQ310PA", CQ310PA.class, ItemIDs.minecartCQ310PA.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Black", "Skin16"}), 18, 0, (new String[] {"Not BAP, but gets to be included"})),
	PCC("PCC", ElectricPCC.class,  ItemIDs.minecartPCC.item, "electric", 220, 80, 0, 10, 0, 170, 0.7, 0.875, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "White"}), 10, -3, (new String[] {"Not BAP, but gets to be included"})),
	...
	WorkdayHyrail("WorkdayHyrail", DieselWorkdayHyrail.class, ItemIDs.minecartWorkdayHyrail.item, "diesel", 110, 115, 0, 2, 0, 10, 0.95, 0.8, 2000,TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Cyan", "Yellow", "Skin17", "Orange", "Skin18"}),20, -2.0),
