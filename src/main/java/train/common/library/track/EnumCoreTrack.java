...
public enum EnumCoreTrack
{
    ...
    CORE_TWO_WAYS_CROSSING,
    CORE_DIAGONAL_TWO_WAYS_CROSSING,

    CORE_DIAMOND_CROSSING,
    CORE_DIAMOND_CROSSING_L,
    CORE_DIAMOND_CROSSING_R,

    CORE_DOUBLE_DIAMOND_CROSSING,

    CORE_FOUR_WAYS_CROSSING,
