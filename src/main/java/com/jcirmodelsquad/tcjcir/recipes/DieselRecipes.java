...
public class DieselRecipes extends AbstractRecipeHandler {
    public DieselRecipes(ITierCraftingManager cm)
    {
        ...
        //super7 & bq23
        cm.addRecipe(2, new ItemStack(ItemIDs.steelcab.item, 1), null, null, SteelIngot(3), null, new ItemStack(ItemIDs.partComponentGE.item, 3), new ItemStack(ItemIDs.minecartU23B.item, 1), new ItemStack(ItemIDs.partComponentGE.item, 3), null, GRAY_DYE, new ItemStack(ItemIDs.minecartB23S7.item, 1), 1);
