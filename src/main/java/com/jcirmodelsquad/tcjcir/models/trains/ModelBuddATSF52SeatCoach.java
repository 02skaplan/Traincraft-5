...
public class ModelBuddATSF52SeatCoach extends ModelConverter//Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelBuddATSF52SeatCoach() //Same as Filename
	{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if(GetColor(entity)==11 || GetColor(entity)==14 || GetColor(entity)==2 || GetColor(entity)==9 || GetColor(entity)==4){
